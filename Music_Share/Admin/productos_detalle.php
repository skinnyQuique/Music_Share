...
?>
<html>
<link rel="stylesheet" href="Diseños/productos-detalle_Diseño.css"> <!-- Esto es para llamar la hoja de diseños -->
<head>
...
<div class="Cuadro-Tiulo ">
    ...
    <div class="InvTabla">
        <div>
            <h1 class="Titulo">Detalles Productos</h1>
        </div>
        <div align="right">
    ...
    <center>
    <div class="Tabla-Mayor" id="TituloTB"> Detalles del producto numero:  <?php echo $id;?></div>
    <div class="Tabla-Mayor">
        <div class="Tabla-menor">
            <table align="center" class="TBdatos">
                <td class="atencion"><?php echo "<img class='imagen' src='Archivos/Productos/$archivo'>" ?></div><br>
                ...
                <td class="one"> <b class="letras">Codigo:</b> <?php echo $codigo ?></td><br>
                <td class="one"> <b class="letras">Nombre:</b> <?php echo $nombre ?></td><br>
                <td class="two"> <b class="letras">Descripcion:</b><br><br> <?php echo $descripcion ?></td><br>
                <td class="one"> <b class="letras">Costo:</b> <?php echo '$', $costo ?></td><br>
                <td class="one"> <b class="letras">Stock:</b> <?php echo $stock?></td><br>
            </table>
