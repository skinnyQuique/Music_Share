...
<link rel="stylesheet" href="Diseños/productos-lista_Diseño.css"> <!-- Esto es para llamar la hoja de diseños -->
...
<!-- <-----------------------------------------------------Esto corresponde al boton de nuevo empleado y ubicacion de pagina-->
    <div class="InvTabla">
        <div>
            <h1 class="Titulo">Lista Productos</h1>
        </div>
        <div align="right">
...
echo "<div class='tabla' id='TituloTB'> 
        ...
        <div class='roles'>
            <b class='font'>Stock</b>
        </div>
        <div class='roles'>
            <b class='font'>Codigo</b>
        </div>
        <div class='roles'>
            <b class='font'>Costo</b>
        </div>
...
// <---------------------------------------------------------------------------Esto corresponde al las Acciones
                echo "<div class='Acciones'  align='center' >
                        <a href='productos_detalle.php?ID=$id'>
                            <img class='Eliminar' src='Imagenes/View.png' >
                        </a>
                        <a href='productos_editar.php?ID=$id'>
